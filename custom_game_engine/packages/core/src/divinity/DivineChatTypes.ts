...
export type ChatNotificationType =
  ...
  | 'peace_made'        // "Two rival deities have made peace"
  | 'alliance_formed'   // "The Storm-Fire Alliance is formed"
  | 'avatar_manifest'   // "A deity walks among mortals"
  | 'avatar_withdraw'   // "A deity has withdrawn from the mortal realm"
  | 'pantheon_formed'   // "A new pantheon is founded"
