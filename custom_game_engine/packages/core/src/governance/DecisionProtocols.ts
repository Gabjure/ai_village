...
export { tierLevel, getNextHigherTier, getTierDisplayName, getAllTiersOrdered, isTierHigherThan };

// ============================================================================
// POLITICAL TIER HIERARCHY
// ============================================================================
// Political tier types and utilities are now imported from ./types.ts
...
// UTILITY FUNCTIONS
// ============================================================================
// Tier utility functions (getTierDisplayName, getAllTiersOrdered, isTierHigherThan)
// are now imported from ./types.ts
