...
export type ChatNotificationType =
  | 'entered'           // "[Deity] has entered the chat"
  | 'left'              // "[Deity] has left the chat"
  | 'returned'          // "[Deity] has returned"
  ...
  | 'domain_claimed'    // "[Deity] claims the Storm domain"
  | 'war_declared'      // "[Deity] declares war on [Deity]"
  | 'peace_made'        // "[Deity] and [Deity] have made peace"
  | 'alliance_formed'   // "The Storm-Fire Alliance is formed"
  | 'avatar_manifest'   // "[Deity] walks among mortals"
  | 'avatar_withdraw'   // "[Deity] has withdrawn from the mortal realm"
  | 'pantheon_formed'   // "The Storm-Kindred pantheon is founded"
